		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Playground",
									"targetURL": "#orgfishermanplayground-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"orgfishermanplayground-display": {
								"semanticObject": "orgfishermanplayground",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=org.fisherman.playground",
									"url": sap.ui.require.toUrl("org/fisherman/playground")
								}
							}
						}
					}
